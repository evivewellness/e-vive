 ...
 *
 * At the time of writing, the client-facing read path does not exist yet and
 * MUST NOT be built until requests can be authenticated server-side. See
 * docs/cardex-security.md for why.
 * ─────────────────────────────────────────────────────────────────────────
 */
