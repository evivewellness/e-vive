...
export default function EVivePortal() {
  ...
  const services = [
    ...
    { icon: "🩺", num: "02", title: "Advisory Consultations", desc: "One-on-one sessions with Salome — CNA, wellness advisor and founder — integrating clinical assessment, nutritional analysis, and compassionate guidance.", tags: ["Clinical", "Telehealth", "1-on-1"], iconClass: "gold", featured: true },
